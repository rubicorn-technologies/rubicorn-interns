  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-5 py-24 lg:px-8">
      ...
      <div className="prose prose-invert mt-8 max-w-none text-muted-foreground">
        <p>
          Training fees are refundable within 7 days of payment if the cohort has not commenced.
          Once the program starts, fees are non-refundable.
        </p>
        <p>
          To request a refund, email admin@rubicorn.in with your order ID and reason. Approved
